...
/// Runs the `user_session_delete` query
/// defined in `./src/app/queries/sql/user_session_delete.sql`.
///
/// > 🐿️ This function was generated automatically using v3.0.1 of
/// > the [squirrel package](https://github.com/giacomocavalieri/squirrel).
///
pub fn user_session_delete(db, arg_1, arg_2) {
...
/// A row you get from running the `user_session_create` query
/// defined in `./src/app/queries/sql/user_session_create.sql`.
///
/// > 🐿️ This type definition was generated automatically using v3.0.1 of the
/// > [squirrel package](https://github.com/giacomocavalieri/squirrel).
///
pub type UserSessionCreateRow {
  UserSessionCreateRow(
    user_id: Uuid,
...
/// Runs the `user_session_create` query
/// defined in `./src/app/queries/sql/user_session_create.sql`.
///
/// > 🐿️ This function was generated automatically using v3.0.1 of
/// > the [squirrel package](https://github.com/giacomocavalieri/squirrel).
///
pub fn user_session_create(db, arg_1, arg_2, arg_3) {
  let decoder = {
    ...
    decode.success(UserSessionCreateRow(user_id:, session_token:, expires_at:))
  }
